...
Player.prototype.handleInput = function ()
{
    ...
    if (keyboard.down(Key_B) && this.bonus.detonator)
    {
        this.parent.activateBombs();
    }

    if (keyboard.down(Key_left) && !keyboard.down(Key_right))
        {
    ...
    if (keyboard.down(Key_right) && !keyboard.down(Key_left))
        {
            if (this.tilePosition.v &&
                    ((!this.isSolidForPlayer(this.tilePosition.xTile+1, this.tilePosition.yTile) ||
    ...
    if (keyboard.down(Key_up) && !keyboard.down(Key_down))
        {
    ...
    if (keyboard.down(Key_down) && !keyboard.down(Key_up))
        {
            if (this.tilePosition.h &&
                    ((!this.isSolidForPlayer(this.tilePosition.xTile, this.tilePosition.yTile+1) ||
...
var mod_Player = Player;
export { mod_Player as Player };
