...
import { back as Key_back, enter as Key_enter } from "..\\..\\system\\Key.js";
...
GameOverState.prototype.handleInput = function (delta) {
  ...
  if (this.game.gamePlayer.name.length > 0 && keyboard.pressed(Key_back)) {
...
var mod_GameOverState = GameOverState;
export { mod_GameOverState as GameOverState };
