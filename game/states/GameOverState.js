...
import { back as systemKeyjs_back, enter as systemKeyjs_enter } from "..\\..\\system\\Key.js";
...
GameOverState.prototype.handleInput = function (delta) {
  if (keyboard.pressed(systemKeyjs_enter)) {
  ...
  if (this.game.gamePlayer.name.length > 0 && keyboard.pressed(systemKeyjs_back)) {
