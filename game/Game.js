import { escape as Key_escape, H, P, Q, S } from "..\\system\\Key.js";
...
Game.prototype.handleInput = function (type) {
    ...
    //
    if (keyboard.pressed(P) && this.gameStateManager.getLastMasterStateId() === "game_state_playing")
        {
        this.gameStateManager.switchTo('game_pause');
        }

    if (keyboard.pressed(Q) && this.gameStateManager.getLastMasterStateId() === "game_state_playing")
        {
