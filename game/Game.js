import { escape as Key_escape, H as Key_H, P as Key_P, Q as Key_Q, S as Key_S } from "..\\system\\Key.js";
...
Game.prototype.handleInput = function (type) {
    ...
    if (keyboard.pressed(Key_H))
        {
        this.gameStateManager.switchTo("hi_score").reset();
        }
    //
    if (keyboard.pressed(Key_P) && this.gameStateManager.getLastMasterStateId() === "game_state_playing")
        {
        this.gameStateManager.switchTo('game_pause');
        }

    if (keyboard.pressed(Key_Q) && this.gameStateManager.getLastMasterStateId() === "game_state_playing")
        {
