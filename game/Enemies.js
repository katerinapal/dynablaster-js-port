  ...
  while(i)
    {
      ...
      var newPosition = {
          x : myHelper_getRandomInt(this.exitPosition.x-3, this.exitPosition.x+3),
          y : myHelper_getRandomInt(this.exitPosition.y-3, this.exitPosition.y+3)
      };
...
var mod_Enemies = Enemies;
export { mod_Enemies as Enemies };
