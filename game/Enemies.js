  ...
  while(i)
    {
      ...
      var newPosition = {
          x : systemmyHelperjs_getRandomInt(this.exitPosition.x-3, this.exitPosition.x+3),
          y : systemmyHelperjs_getRandomInt(this.exitPosition.y-3, this.exitPosition.y+3)
      };
...
var exported_Enemies = Enemies;
export { exported_Enemies as Enemies };
