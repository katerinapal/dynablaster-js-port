...
import { getRandomInt as myHelper_getRandomInt } from "..\\system\\myHelper.js";
...
Map.prototype.makeBrick = function (count) {
    ...
    {
        x = myHelper_getRandomInt(1, this.grid.size.width-2);
        y = myHelper_getRandomInt(1, this.grid.size.height-2);
