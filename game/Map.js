...
import { getRandomInt as systemmyHelperjs_getRandomInt } from "..\\system\\myHelper.js";
import { sounds } from "..\\system\\Sounds.js";
import { PointsList } from ".\\PointsList.js";
import { GridBonus } from ".\\grids\\GridBonus.js";
import { MapTimer } from ".\\MapTimer.js";
import { GridBombs } from ".\\grids\\GridBombs.js";
import { GridBricks } from ".\\grids\\GridBricks.js";
import { GridSteel } from ".\\grids\\GridSteel.js";
import { GridWalls } from ".\\grids\\GridWalls.js";
import { GridGrass } from ".\\grids\\GridGrass.js";
...
Map.prototype.makeBrick = function (count) {
    ...
    {
        x = systemmyHelperjs_getRandomInt(1, this.grid.size.width-2);
        y = systemmyHelperjs_getRandomInt(1, this.grid.size.height-2);
...
var exported_Map = Map;
export { exported_Map as Map };
export { result };
