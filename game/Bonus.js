...
Bonus.prototype.addRandom = function () {
    ...
    while(added === false)
    {
        var rand = systemmyHelperjs_getRandomInt(0,this.bonuses.length-1);
...
Bonus.prototype.init = function () {
    ...
    this.bonusesOut = systemmyHelperjs_shuffleArray(this.bonusesOut);
};


var exported_Bonus = Bonus;
export { exported_Bonus as Bonus };
